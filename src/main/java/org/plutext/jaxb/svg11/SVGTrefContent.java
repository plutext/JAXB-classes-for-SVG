...
/**
 * <p>Java class for SVG.tref.content complex type.
 * 
...
public class SVGTrefContent {
    ...
    protected List<JAXBElement<?>> animateOrSetOrAnimateColor;
     ...
     * 
     */
    public List<JAXBElement<?>> getAnimateOrSetOrAnimateColor() {
        if (animateOrSetOrAnimateColor == null) {
            animateOrSetOrAnimateColor = new ArrayList<JAXBElement<?>>();
        }
