...
/**
 * <p>Java class for SVG.altGlyphDef.content complex type.
 * 
...
public class SVGAltGlyphDefContent {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the altGlyphItem property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<AltGlyphItem> getAltGlyphItem() {
        if (altGlyphItem == null) {
            altGlyphItem = new ArrayList<AltGlyphItem>();
        }
